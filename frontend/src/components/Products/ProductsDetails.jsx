...
const selectedProduct = {
    ...
    price: 120,
    originalPrice : 150,
    description : "This is the stylish jacket perfect for any occasion",
    brand : "FashionBrand",
    material : "Leather",
    sizes : ["S","M","L","XL"],
    colors : ["Red","Black"],
                ...
                <div className='md:w-1/2 md:ml-10'>
                    ...
                    <div className='mb-6'>
                        ...
                        disabled= {isButtonDisabled}
                         className= {`bg-black text-white py-2 px-6 rounded w-full mt-5 ${isButtonDisabled ? "cursor-not-allowed opacity-50" : "hover:bg-gray-900" }`}>
